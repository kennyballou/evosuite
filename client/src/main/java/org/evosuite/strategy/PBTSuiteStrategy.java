/*
 * Copyright (C) 2023 Gordon Fraser, Andrea Arcuri and EvoSuite
 * contributors
 *
...
/**
 * This strategy attempts to generate a fixed number of random tests which
 * cover particular branches.
 *
 * @author kb
 */
public class PBTSuiteStrategy extends TestGenerationStrategy {
